...
export default function CategoryMarquee() {
  ...
  return (
    <div className="bg-brand-orange text-white py-3 overflow-x-auto flex whitespace-nowrap" style={{ scrollbarWidth: 'none' }}>
      <div className="sm:animate-marquee hover:[animation-play-state:paused] flex gap-6 sm:gap-10 px-4 items-center w-max hover:cursor-pointer">
